    ...
    <div
        ...
        <main class="flex max-w-[935px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Foydalanildi</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Laravel 12 <br>
                    Php 8.2<br> Laravel Sail (Docker) <br> PostgreSql <br> Sanctum</p>

                                    <h1 class="mb-1 font-medium">Admin User</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">email: admin@example.com <br>
                    password : password</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Api file (Postman, Apidog)
<a href="{{ route('download.file', 'api.zip') }}"
   class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1">
                        ...
                        <span>
                            Loyiha ZIP
<a href="{{ route('download.file', 'loyiha.zip') }}"
   class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ml-1">
